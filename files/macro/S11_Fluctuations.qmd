...
though, as we will see, in this case the autoregressive parameter should be larger than one (consumption grows steadily). One corollary is that we cannot estimate an AR(1) process for this.
