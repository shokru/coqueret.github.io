...
The [Energy Institute](https://www.energyinst.org/statistical-review/resources-and-data-downloads) compiles a valuable (& updated) [dataset](https://www.energyinst.org/__data/assets/excel_doc/0006/1656348/Statistical-Review-of-World-Energy-Data.xlsx) on energy production by source. The data is too rich (90 variables), hence we restrict it to a few items.
...
#| class-source: my_class
#| classes: my_class
df <- read_excel("Statistical-Review-of-World-Energy-Data.xlsx") 
data_energy <- df |> 
...
Another related paper: [Growth, Interrupted: How Crises delay Global Convergence](https://www.imf.org/en/Publications/WP/Issues/2025/06/13/Growth-Interrupted-How-Crises-delay-Global-Convergence-567257):

![](transitions.png){width=90% align="center"} 
...
Finally, some additional material from this [post](https://www.chat-gdp.org/we-were-wrong-about-convergence/):

![](convergence_2.png){width=85% align="center"} 
