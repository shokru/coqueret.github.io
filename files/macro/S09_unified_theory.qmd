...
Note that in the UN files, population trends depend on **scenarios**...
...
A first major question will be that of demographic transition for African countries (will it occur?).    
A second one may be **climate change**: how it will affect fertility and mortality is an important unknown. 
